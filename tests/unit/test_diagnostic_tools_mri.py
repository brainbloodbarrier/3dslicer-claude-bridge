...
class TestClassifyModicChanges:
    ...
    def test_successful_modic_classification(self):
        ...
        with patch("slicer_mcp.features.diagnostics.mri.get_client") as mock_get_client:
            mock_client = Mock()
...
class TestServerRegistration:
    ...
    def test_server_error_handling_modic(self):
        ...
        with patch("slicer_mcp.server.diagnostic_tools_mri.classify_modic_changes") as mock_tool:
...
class TestMriSegmentationNodeIdValidation:
    ...
    def test_modic_valid_seg_id(self):
        ...
        with patch("slicer_mcp.features.diagnostics.mri.get_client") as mock_gc:
            mock_client = Mock()
            mock_client.exec_python.return_value = {
                "success": True,
                "result": json.dumps(mock_result),
