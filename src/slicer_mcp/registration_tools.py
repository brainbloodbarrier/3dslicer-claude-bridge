...
_module = _import_module("slicer_mcp.features.registration")

warnings.warn(
    "Importing from 'slicer_mcp.registration_tools' is deprecated. "
    "Use 'slicer_mcp.features.registration' instead.",
    DeprecationWarning,
    stacklevel=2,
)
