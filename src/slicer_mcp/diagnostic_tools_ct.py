...
_module = _import_module("slicer_mcp.features.diagnostics.ct")

warnings.warn(
    "Importing from 'slicer_mcp.diagnostic_tools_ct' is deprecated. "
    "Use 'slicer_mcp.features.diagnostics.ct' instead.",
    DeprecationWarning,
    stacklevel=2,
)
